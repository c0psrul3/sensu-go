...
func (r *entityImpl) Events(p schema.EntityEventsFieldResolverParams) (interface{}, error) {
	...
	records := filterEvents(results, func(obj *v2.Event) bool {
		return matches(obj)
	})
...
func (r *entityImpl) Related(p schema.EntityRelatedFieldResolverParams) (interface{}, error) {
	...
	// omit self
	records := filterEntities(results, func(obj *v2.Entity) bool {
...
func (r *entityImpl) Status(p graphql.ResolveParams) (interface{}, error) {
	...
	evs := filterEvents(results, func(obj *v2.Event) bool {
...
func filterSilenceByEntity(src *v2.Entity) silencePredicate {
	now := time.Now().Unix()
	return func(obj *v2.Silenced) bool {
...
func (r *networkInterfaceImpl) Mac(p graphql.ResolveParams) (string, error) {
	i := p.Source.(v2.NetworkInterface)
	return i.MAC, nil
}
